...
public class RelicItems {
    ...
    public static final SlimefunItemStack COMMON_RELIC_CTHONIAN_PEARL = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("common-relic-cthonian-pearl.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("common-relic-cthonian-pearl.lore")
    );
    ...
    public static final SlimefunItemStack COMMON_RELIC_RING_OF_SUFFERING = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("common-relic-ring-of-suffering.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("common-relic-ring-of-suffering.lore")
    );
    ...
    public static final SlimefunItemStack COMMON_RELIC_FISHING_SACK = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("common-relic-fishing-sack.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("common-relic-fishing-sack.lore")
    );
    ...
    public static final SlimefunItemStack COMMON_RELIC_PETTY_MARBLE_BLOCK = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("common-relic-petty-marble-block.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("common-relic-petty-marble-block.lore")
    );
    ...
    public static final SlimefunItemStack COMMON_RELIC_HEALING_POTION = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("common-relic-healing-potion.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("common-relic-healing-potion.lore")
    );
    ...
    public static final SlimefunItemStack COMMON_RELIC_LEATHER_HELMET = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("common-relic-leather-helmet.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("common-relic-leather-helmet.lore")
    );
    ...
    public static final SlimefunItemStack COMMON_RELIC_MUSHROOM = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("common-relic-mushroom.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("common-relic-mushroom.lore")
    );
    ...
    public static final SlimefunItemStack UNCOMMON_RELIC_PINK_SALT = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("uncommon-relic-pink-salt.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("uncommon-relic-pink-salt.lore")
    );
    ...
    public static final SlimefunItemStack UNCOMMON_RELIC_SKULL_HAT = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("uncommon-relic-skull-hat.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("uncommon-relic-skull-hat.lore")
    );
    ...
    public static final SlimefunItemStack UNCOMMON_RELIC_CTHONIAN_TOKEN = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("uncommon-relic-cthonian-token.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("uncommon-relic-cthonian-token.lore")
    );
    ...
    public static final SlimefunItemStack UNCOMMON_RELIC_AGED_WINE = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("uncommon-relic-aged-wine.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("uncommon-relic-aged-wine.lore")
    );
    ...
    public static final SlimefunItemStack UNCOMMON_RELIC_TANZANITE_BLOCK = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("uncommon-relic-tanzanite-block.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("uncommon-relic-tanzanite-block.lore")
    );
    ...
    public static final SlimefunItemStack UNCOMMON_RELIC_BLUE_GLOWSTONE = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("uncommon-relic-blue-glowstone.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("uncommon-relic-blue-glowstone.lore")
    );
    ...
    public static final SlimefunItemStack UNCOMMON_RELIC_GRAY_BERRY = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("uncommon-relic-gray-berry.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("uncommon-relic-gray-berry.lore")
    );
    ...
    public static final SlimefunItemStack RARE_RELIC_MARRIAGE_RING = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("rare-relic-marriage-ring.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("rare-relic-marriage-ring.lore")
    );
    ...
    public static final SlimefunItemStack RARE_RELIC_BLAZE_ASHES = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("rare-relic-blaze-ashes.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("rare-relic-blaze-ashes.lore")
    );
    ...
    public static final SlimefunItemStack RARE_RELIC_CROSSED_SWORDS = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("rare-relic-crossed-swords.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("rare-relic-crossed-swords.lore")
    );
    ...
    public static final SlimefunItemStack RARE_RELIC_CERULEAN_GEM = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("rare-relic-cerulean-gem.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("rare-relic-cerulean-gem.lore")
    );
    ...
    public static final SlimefunItemStack RARE_RELIC_TERRACOTTA_POT = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("rare-relic-terracotta-pot.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("rare-relic-terracotta-pot.lore")
    );
    ...
    public static final SlimefunItemStack RARE_RELIC_GOLDEN_JAR = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("rare-relic-golden-jar.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("rare-relic-golden-jar.lore")
    );
    ...
    public static final SlimefunItemStack RARE_RELIC_HORN_OF_TAURUS = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("rare-relic-horn-of-taurus.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("rare-relic-horn-of-taurus.lore")
    );
    ...
    public static final SlimefunItemStack EPIC_RELIC_LUMINOUS_PEARL = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("epic-relic-luminous-pearl.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("epic-relic-luminous-pearl.lore")
    );
    ...
    public static final SlimefunItemStack EPIC_RELIC_VALIANT_TALISMAN = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("epic-relic-valiant-talisman.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("epic-relic-valiant-talisman.lore")
    );
    ...
    public static final SlimefunItemStack EPIC_RELIC_FLAWLESS_AQUA_GEM = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("epic-relic-flawless-aqua-gem.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("epic-relic-flawless-aqua-gem.lore")
    );
    ...
    public static final SlimefunItemStack EPIC_RELIC_BOTTLE_O_POWER = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("epic-relic-bottle-o-power.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("epic-relic-bottle-o-power.lore")
    );
    ...
    public static final SlimefunItemStack EPIC_RELIC_FERVOR_HELMET = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("epic-relic-fervor-helmet.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("epic-relic-fervor-helmet.lore")
    );
    ...
    public static final SlimefunItemStack EPIC_RELIC_THUNDER_IN_A_BOTTLE = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("epic-relic-thunder-in-a-bottle.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("epic-relic-thunder-in-a-bottle.lore")
    );
    ...
    public static final SlimefunItemStack LEGENDARY_RELIC_MYSTERIOUS_HOLOCRON = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("legendary-relic-mysterious-holocron.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("legendary-relic-mysterious-holocron.lore")
    );
    ...
    public static final SlimefunItemStack LEGENDARY_RELIC_EYE_OF_SAURON = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("legendary-relic-eye-of-sauron.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("legendary-relic-eye-of-sauron.lore")
    );
    ...
    public static final SlimefunItemStack LEGENDARY_RELIC_SKULL_OF_PROMETHEUS = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("legendary-relic-skull-of-prometheus.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("legendary-relic-skull-of-prometheus.lore")
    );
    ...
    public static final SlimefunItemStack LEGENDARY_RELIC_MAGMA_GAUNTLET = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("legendary-relic-magma-gauntlet.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("legendary-relic-magma-gauntlet.lore")
    );
    ...
    public static final SlimefunItemStack LEGENDARY_RELIC_GLAZING_PEARL = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("legendary-relic-glazing-pearl.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("legendary-relic-glazing-pearl.lore")
    );
    ...
    public static final SlimefunItemStack LEGENDARY_RELIC_SAPPHIRE_RING = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("legendary-relic-sapphire-ring.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("legendary-relic-sapphire-ring.lore")
    );
    ...
    public static final SlimefunItemStack COMMON_RELIC_VOIDER = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("common-relic-voider.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("common-relic-voider.lore")
    );
    ...
    public static final SlimefunItemStack UNCOMMON_RELIC_VOIDER = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("uncommon-relic-voider.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("uncommon-relic-voider.lore")
    );
    ...
    public static final SlimefunItemStack RARE_RELIC_VOIDER = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("rare-relic-voider.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("rare-relic-voider.lore")
    );
    ...
    public static final SlimefunItemStack EPIC_RELIC_VOIDER = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("epic-relic-voider.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("epic-relic-voider.lore")
    );
    ...
    public static final SlimefunItemStack LEGENDARY_RELIC_VOIDER = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("legendary-relic-voider.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("legendary-relic-voider.lore")
    );
    ...
    public static final SlimefunItemStack RELIC_DROP_TYPE = new SlimefunItemStack(
            ...
            RelicsOfCthonia.getInstance().getLocale().string("relic-drop-type.name"),
            RelicsOfCthonia.getInstance().getLocale().stringArray("relic-drop-type.lore")
    );
